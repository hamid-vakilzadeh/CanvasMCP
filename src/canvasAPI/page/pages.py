...
def show_front_page(
    ...
    response = _make_request(
        base_url, access_token, "GET", f"/api/v1/{context_type}/{context_id}/front_page"
    )
...
def duplicate_page(
    ...
    response = _make_request(
        ...
        access_token,
        "POST",
        f"/api/v1/courses/{course_id}/pages/{url_or_id}/duplicate",
    )
    return response.json()
...
def update_front_page(
    ...
    response = _make_request(
        ...
        access_token,
        "PUT",
        f"/api/v1/{context_type}/{context_id}/front_page",
        data=data,
    )
    return response.json()
...
def list_pages(
    ...
    if all_pages:
        return _get_all_pages(
            ...
            access_token,
            "GET",
            f"/api/v1/{context_type}/{context_id}/pages",
            params=params,
        )
    else:
        response = _make_request(
...
def show_page(
    ...
    response = _make_request(
        ...
        access_token,
        "GET",
        f"/api/v1/{context_type}/{context_id}/pages/{url_or_id}",
    )
    return response.json()
