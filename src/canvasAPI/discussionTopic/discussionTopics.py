...
class AssignmentData(TypedDict, total=False):
    ...
    grading_type: Optional[
        Literal["pass_fail", "percent", "letter_grade", "gpa_scale", "points"]
    ]
...
def list_discussion_topics(
    ...
    if exclude_context_module_locked_topics is not None:
        params["exclude_context_module_locked_topics"] = (
...
def create_discussion_topic(
    ...
    title: str = None,
    message: str = None,
    discussion_type: Optional[
        Literal["side_comment", "threaded", "not_threaded"]
    ] = None,
...
def delete_discussion_topic(
    ...
    response = _make_request(base_url, access_token, "DELETE", endpoint)
    return response.json()
...
def duplicate_discussion_topic(
    ...
    response = _make_request(base_url, access_token, "POST", endpoint)
    return response.json()
...
def list_entries_by_ids(
    ...
    if course_id:
        endpoint = (
            f"/api/v1/courses/{course_id}/discussion_topics/{topic_id}/entry_list"
        )
    else:
...
def update_entry(
    ...
    if course_id:
        ...
        endpoint = (
            f"/api/v1/groups/{group_id}/discussion_topics/{topic_id}/entries/{entry_id}"
        )
...
def mark_topic_read(
    ...
    _make_request(base_url, access_token, "PUT", endpoint)
...
def mark_topic_unread(
    ...
    _make_request(base_url, access_token, "DELETE", endpoint)
...
def mark_all_entries_read(
    ...
    _make_request(base_url, access_token, "PUT", endpoint, params=params)
...
def mark_all_entries_unread(
    ...
    _make_request(base_url, access_token, "DELETE", endpoint, params=params)
...
def rate_entry(
    ...
    _make_request(base_url, access_token, "POST", endpoint, data=data)
...
def subscribe_to_topic(
    ...
    if course_id:
        endpoint = (
            f"/api/v1/courses/{course_id}/discussion_topics/{topic_id}/subscribed"
        )
    else:
...
def disable_summary(
    ...
    if course_id:
        ...
        endpoint = (
            f"/api/v1/groups/{group_id}/discussion_topics/{topic_id}/summaries/disable"
        )

    response = _make_request(base_url, access_token, "PUT", endpoint)
    return response.json()
...
def submit_summary_feedback(
    ...
    action: Literal[
        "seen", "like", "dislike", "reset_like", "regenerate", "disable_summary"
    ] = None,
) -> Dict:
    """
