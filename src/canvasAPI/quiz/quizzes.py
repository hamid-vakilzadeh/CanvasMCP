...
def get_quiz(
    ...
    """
    response = _make_request(
        base_url, access_token, "GET", f"/api/v1/courses/{course_id}/quizzes/{quiz_id}"
    )
    return response.json()
...
def update_quiz(
    ...
    if show_correct_answers_last_attempt is not None:
        data["quiz[show_correct_answers_last_attempt]"] = (
...
def reorder_quiz_items(
    ...
    _make_request(
        ...
        access_token,
        "POST",
        f"/api/v1/courses/{course_id}/quizzes/{quiz_id}/reorder",
        data=data,
    )
...
def validate_access_code(
    ...
    response = _make_request(
        ...
        access_token,
        "POST",
        f"/api/v1/courses/{course_id}/quizzes/{quiz_id}/validate_access_code",
        data=data,
    )
    return response.json()
